function ConfirmDialog({ aberto, titulo, mensagem, onConfirmar, onCancelar, carregando }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-sm bg-atend-card border border-atend-border rounded-2xl shadow-2xl p-6 z-10">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={onConfirmar}
            disabled={carregando}
            className="flex-1 bg-rose-600 hover:bg-rose-500 disabled:opacity-50 text-white text-sm font-bold py-2.5 rounded-lg transition-all"
          >
